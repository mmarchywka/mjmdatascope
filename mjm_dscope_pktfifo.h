 //  cpputil rename on Mon May 1 08:51:15 EDT 2023 from mjm_dscope_dgram to mjm_dscope_pktfifo
#ifndef MJM_DSCOPE_PKTFIFO_H__
#define MJM_DSCOPE_PKTFIFO_H__
...
// generated by /home/documents/cpp/scripts/cpputil -classhdr mjm_dscope_pktfifo   
// g++  -Wall -std=gnu++11 -DTEST_MJM_DSCOPE_PKTFIFO -I. -I../../mjm/hlib -I../../mjm/num  -gdwarf-3 -O0  -x c++ mjm_dscope_pktfifo.h  -o mjm_dscope_pktfifo.out -lpthread -lreadline

mjm_global_credits::credit __credit__mjm_dscope_pktfifo("mjm_dscope_pktfifo"
, "  ");

template <class Tr>
class mjm_dscope_pktfifo 
{
 typedef mjm_dscope_pktfifo Myt;
...
//enum{HDRSZ=PAYLOAD};
// THIS AFCK SAILED BECAUSE THE FIG ints are only 32 fing
// bits
...
mjm_dscope_pktfifo() {Init(); }
~mjm_dscope_pktfifo() {Free();}
...
{
Ss ss;
// this asfer is the right as order f 
std::vector<IdxTy> v;
...
IdxTy Sht(const StrTy fu) 
{
MM_ERR(MMPR(__FUNCTION__))
const char * p =fu.c_str();
IdxTy sht=0;
IdxTy sp=0;
IdxTy pc=0;
// instead of fixing this  order fix it at the fing end. 
while (p[pc]!=0)
{
...
template <class Tr>
class mjm_dscope_pktfifo_map : public std::map<typename Tr::StrTy, mjm_dscope_pktfifo< Tr > >  
{
 typedef mjm_dscope_pktfifo_map Myt;
typedef typename std::map<typename Tr::StrTy, mjm_dscope_pktfifo< Tr> >   Super;
 typedef typename Tr::IdxTy IdxTy;
 typedef typename Tr::D D;
 typedef typename Tr::StrTy StrTy;
 typedef typename Tr::Ss Ss;
...
typedef tester_< mjm_dscope_pktfifo <Tr>  > tester;
...
{
Ss ss;
ss<<" MJM_DSCOPE_PKTFIFO "<<__DATE__<<" "<<__TIME__<<CRLF;
MM_ERR(ss.str())
...
{
about();
typedef mjm_dscope_pktfifo<Tr>  Myt;
//Myt x(argc,args);
Myt x;
